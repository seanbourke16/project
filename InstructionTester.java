...
public class InstructionTester {
	...
	public void testNOP() {
		...
		assertEquals("Program counter incremented", ipInit + 1, machine.getpCounter());
	...
	public void testLODdirect() {
		...
		assertEquals("Program counter incremented", ipInit + 1, machine.getpCounter());
		// Test accumulator modified
		assertEquals("Accumulator changed", dataCopy[offsetinit + 12], machine.getAccum());
	}
	...
	public void testLODindirect() {
		...
		assertEquals("Accumulator changed", dataCopy[offsetinit + offset1], machine.getAccum());
	}
	...
	public void testADDimmediate() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getpCounter());
	...
	public void testADDdirect() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getpCounter());
		assertEquals("Accumulator was changed", 250 - 10240 + 2120, machine.getAccum());
	}
	...
	public void testADDindirect() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getpCounter());
		assertEquals("Accumulator was changed", 250 - 3840, machine.getAccum());
	}
	...
	public void testSUBdirect() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getpCounter());
		assertEquals("Accumulator was changed", 200 - (-10240 + 2120), machine.getAccum());
	}
	...
	public void testMULindirect() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getpCounter());
		assertEquals("Accumulator was changed", 200 * (-3840), machine.getAccum());
	}
	...
	public void testDIVdirect() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getpCounter());
		assertEquals("Accumulator was changed", 1024011 / (-10240 + 2120), machine.getAccum());
	}
	...
	public void testDIVindirect() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getpCounter());
		assertEquals("Accumulator was changed", 400000 / (-3840), machine.getAccum());
	}
	...
	public void testJUMPimmediate() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was changed", 400 + 260, machine.getpCounter());
	...
	public void testJUMPdirect() {
		Instruction instr = machine.get(0xB);
		int arg = 1024 - 160; // the memory value is data[offsetinit-160 + 1024]
								// = 400
		machine.setAccum(200);
		machine.setpCounter(400);
		instr.execute(arg, 1);
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was changed", 800, machine.getpCounter());
		assertEquals("Accumulator was not changed", 200, machine.getAccum());
	}
	...
	public void testJUMPindirect() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was changed", 760, machine.getpCounter());
		assertEquals("Accumulator was not changed", 200, machine.getAccum());
	}
	...
	public void testJUMPabsolute() {
		...
		// should add 360 to the program counter
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was changed", 777 + 860, machine.getpCounter());
		assertEquals("Accumulator was not changed", 200, machine.getAccum());
	}
	...
	public void testJMPZindirectAccumNonZero() {
		...
		// should have set the program counter incremented
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was changed", ipInit + 1, machine.getpCounter());
		assertEquals("Accumulator was not changed", 200, machine.getAccum());
	}
	...
	public void testJMPZabsoluteAccumNonZero() {
		...
		// should add 360 to the program counter
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was changed", 401, machine.getpCounter());
		assertEquals("Accumulator was not changed", 200, machine.getAccum());
	}
